...
$ test-ugs-asset-gen-a --help
  ...
  Examples
    ...
    $ test-ugs-asset-gen-a https://onderceylan.github.io/test-ugs-asset-gen-a/static/logo.png ./temp -p "15%" -b "linear-gradient(to right, #fa709a 0%, #fee140 100%)"
    $ test-ugs-asset-gen-a https://onderceylan.github.io/test-ugs-asset-gen-a/static/blm.png ./blm -p "15%" -b "linear-gradient(to right top, #d16ba5, #c777b9, #ba83ca, #aa8fd8, #9a9ae1, #8aa7ec, #79b3f4, #69bff8, #52cffe, #41dfff, #46eefa, #5ffbf1)"
